...
export function CorrectionSheet({
  ...
  const averageTime = Math.round(
    playerAnswers.reduce((sum, a) => sum + a.timeSpent, 0) /
  ...
  const getPlayerAnswer = (questionId: string) => {
    return (
      playerAnswers.find((a) => a.questionId === questionId)?.answer ||
      "Pas de réponse"
    );
  };
  ...
  const getTimeSpent = (questionId: string) => {
    return (
      playerAnswers.find((a) => a.questionId === questionId)?.timeSpent || 0
    );
  };
                    ...
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <div className="flex items-center space-x-4">
                        <div className="flex items-center space-x-2 text-sm text-gray-600">
                          ...
                          <span>
                            {timeSpent}s / {question.timeLimit}s
                          </span>
                        </div>
                        <div
