...
export default function RoomPage({ params }: RoomPageProps) {
  ...
  const { currentRoom, gameState, isConnected, connect, leaveRoom, error } =
    useSocket();
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">Code de la salle : {params.id}</p>
          <p className="text-sm text-gray-500">
            Si cette page ne se charge pas, la salle n&apos;existe peut-être
            pas.
          </p>
        </div>
      </div>
